...
async function main() {
  ...
  // Deploy the AcmeNFT contract
  const MyNFT = await hre.ethers.getContractFactory("MyNFT");
  const acmeNFT = await MyNFT.deploy();
  await acmeNFT.deployed();
  console.log("MyNFT deployed to:", acmeNFT.address);

  // Uncomment and update the following lines if you want to deploy other contracts
